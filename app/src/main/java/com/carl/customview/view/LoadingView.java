package com.carl.customview.view;
...
import com.carl.customview.R;


/**
 * Created by yubin on 2017/11/29.
 */
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            t = context.obtainStyledAttributes(attrs, R.styleable.LoadingView,
                    0, defStyleAttr);
            setbGradient(t.getBoolean(R.styleable.LoadingView_bGradient, true));
     /*       circleColor = t.getColor(R.styleable.LoadingView_circleColor,
                    getResources().getColor(android.R.color.holo_blue_light));*/
            circleColor = t.getColor(R.styleable.LoadingView_circleColor,
                    ContextCompat.getColor(context,R.color.colorAccent));
            circleWidth = t.getDimensionPixelSize(R.styleable.LoadingView_circleWidth,
                    10);
            radius = t.getDimensionPixelSize(R.styleable.LoadingView_radius,
                    50);
        } finally {
            if (t != null) {
                t.recycle();
